#!/usr/bin/env python3
"""
Script to create a test incident with messages for testing
Run this to set up test data for the messaging system
"""
...
from app.models.incident import IncidentCreate, IncidentStatus, IncidentLocation
from app.models.message import MessageType

async def create_test_incident():
    """Create a test incident with messages"""
    
    try:
        print("Creating test incident and messages...")
        ...
        incident_data = IncidentCreate(
            ...
            description="This is a test incident for messaging system",
            severity="medium",
...
if __name__ == "__main__":
    asyncio.run(create_test_incident()) 